...
import com.example.Runner8.ui.summary.home.EventBus;
...
public class LocationService extends Service {
    ...
    private static final String EXTRA_STARED_FROM_NOTIFICATION = "com.example.menu.ui.map.ForegroundService"
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        boolean startedFromNotification = intent.getBooleanExtra(EXTRA_STARED_FROM_NOTIFICATION, false);
    ...
    private void removeLocationUpdates() {
        try{
            ...
            Common.setRequestingLocationUpdates(this, false);
            Log.e("EDMT_DEV", "Lost location permission. Could not remove updates" + ex.toString());
        }
    }
    ...
    private void getLastLocation() {
        try{
            ...
            Log.e("EDMT_DEV", "Lost location permission." + ex.toString());
        }
    }
    ...
    private void onNewLocation(Location lastLocation) {
        ...
        EventBus.getInstance().post(new SendLocationToActivity(mLocation));
    ...
    private Notification getNotification() {
        ...
        intent.putExtra(EXTRA_STARED_FROM_NOTIFICATION, true);
    ...
    public boolean onUnbind(Intent intent) {
        if(!mChangingConfiguration && Common.setRequestingLocationUpdates(this))
