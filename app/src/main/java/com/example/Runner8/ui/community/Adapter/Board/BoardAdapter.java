package com.example.Runner8.ui.community.Adapter.Board;
...
public class BoardAdapter extends RecyclerView.Adapter<BoardAdapter.ViewHolder> {
    ...
    public BoardAdapter(Activity activity , ArrayList<BoardModel> dataArrayList){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view;
        if(com_user_activity){
            view = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.list_com_user_activity,parent,false);
        }
        else{
            view = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.listboarditem,parent,false);
        }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        db.collection("Users").document(data.getUid())
                ...
                .get().addOnCompleteListener(task -> {
                    ...
                    Log.i("data.getUid()", "data.getUid() : " + data.getUid() +"  "+ document.get("user_img").toString());
                    Log.i("holder.itemView", holder.itemView.toString());
        ...
        if(Integer.valueOf(data.getTitle().length()) > 57)
            holder.title.setText(data.getTitle().substring(0, 57) + "...");
        else
        ...
        public ViewHolder(@NonNull View view){
            ...
            view.setOnClickListener(v -> {
                ...
                if (pos != RecyclerView.NO_POSITION) {
                    ...
                    //
                    boardModel.setArray_position(String.valueOf(pos));
